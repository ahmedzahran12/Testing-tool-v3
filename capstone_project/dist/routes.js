...
router.delete('/orders/:id', authMiddleware_1.authMiddleware, (0, authMiddleware_1.authorizeRoles)(['admin', 'customer']), orderController_1.orderController.deleteOrder);
...
router.post('/orders/:id/ship', authMiddleware_1.authMiddleware, (0, authMiddleware_1.authorizeRoles)(['admin']), orderController_1.orderController.shipOrder);
