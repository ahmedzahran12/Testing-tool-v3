...
class ItemService {
    findAll() {
        return __awaiter(this, void 0, void 0, function* () {
            const items = yield itemRepository_1.itemRepository.findAll();
    ...
    create(itemData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const newItem = Object.assign(Object.assign({}, itemData), { isActive: true });
            return itemRepository_1.itemRepository.create(newItem);
        });
    }
    update(id, itemData) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    delete(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield itemRepository_1.itemRepository.update(id, existingItem);
        });
    }
}
